 ...
 * src/assets/icons/, a project-owned folder src/utils/iconLibraries.ts can
 * glob with Vite's import.meta.glob.
 *
 ...
 *
 * Keep the library list here in sync with the glob patterns and library
 * metadata in src/utils/iconLibraries.ts.
 */
...
const destRoot = join(packageRoot, 'src', 'assets', 'icons')
